...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    coordinator = GlowmarktDataUpdateCoordinator(hass=hass, api_client=client, tariff_config=tariff_config, virtual_entity_id=entry.data.get(CONF_VIRTUAL_ENTITY))
